...
/******************************************************************************
* 1. Буферы p_data_in и p_data_in_out должны быть выровнены по 8 байт.
* 2. Буфер ключа p_key длинной максимум 32 байта.
* Если длинна p_key меньше 32, то недостающие байты приняты как ноль.
*/
